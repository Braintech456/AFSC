    ...
    <main className="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Head Office: Kaushal, 1st Floor, Near Gauri Shankar Mandir, Sector 9A, Gurugram - 122001<br />
                    Regional Office: 3rd Floor, Indira Heights, Old Gangapur Naka, Gangapur Road, Nashik - 422005
                  </p>
                </div>
              </div>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-10 mb-16 shadow-lg">
          ...
          <form
            action="https://formspree.io/f/mzdarnyw"
            method="POST"
            className="space-y-6"
          >
            {/* Optional redirect */}
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-blue-700 text-white py-3 px-6 rounded-lg font-semibold hover:from-blue-600 hover:to-blue-800 transition flex items-center justify-center gap-2"
            >
              <Send size={20} />
              Send Message
            </button>
        ...
        <section className="bg-gradient-to-br from-slate-100 to-slate-200 rounded-2xl p-10 shadow-lg">
          ...
          <div className="space-y-6 text-gray-700">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="mt-2">
                Use the “Verify” section on the website by entering certificate details.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="mt-2">
                No. AFSC does not charge for basic verification.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="mt-2">
                Apply via the Authorized Centers section.
              </p>
            </div>
          </div>
        </section>
