      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link
              to="/certifications"
              className={`${isActive('/certifications')} hover:text-blue-600 font-medium transition-colors`}
            >
              Certifications
            </Link>
            <Link
              to="/authorized-centers"
              className={`${isActive('/authorized-centers')} hover:text-blue-600 font-medium transition-colors`}
            >
              Authorized Centers
            </Link>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4">
            <nav className="flex flex-col space-y-3">
              ...
              <Link
                to="/certifications"
                className={`${isActive('/certifications')} hover:text-blue-600 font-medium`}
              >
                Certifications
              </Link>
              <Link
                to="/authorized-centers"
                className={`${isActive('/authorized-centers')} hover:text-blue-600 font-medium`}
              >
                Authorized Centers
              </Link>
