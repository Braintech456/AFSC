      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Verify the authenticity of AFSC certifications, authorized training
            centers, and registered chapters through our official registry.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-6">
              Validate the authenticity of registered AFSC chapters and centers
          ...
          <div className="grid md:grid-cols-2 gap-8 text-gray-700">
            <div>
              <p className="mb-4">
                ...
                credentials, authorized centers, and registered chapters.
              </p>
              <p>
