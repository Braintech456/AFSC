      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Expanding across India to bring quality accounting and finance
            education to every district. Find a training center near you.
          </p>
        </div>
          ...
          <div className="bg-white border-2 border-blue-200 rounded-xl p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <span>
                  Every district headquarters has a certified training facility
                </span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-teal-500 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <p className="text-blue-50 text-lg mb-8 max-w-2xl mx-auto">
            Partner with us to establish a training center in your district. Join
            our mission to make skill development accessible to all.
          </p>
